...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SMF");
    case mBTC: return QString("mSMF");
    case uBTC: return QString::fromUtf8("μSMF");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SmurfsCoins"));
    case mBTC: return QString(QObject::tr("Milli-SmurfsCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SmurfsCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
